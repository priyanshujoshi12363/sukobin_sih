package com.sukobin.app.ui.splash
...
import com.sukobin.app.databinding.ActivitySplashBinding
...
class SplashActivity : AppCompatActivity() {
    ...
    private suspend fun resolveDestination(): Class<*> {
        ...
        return when (val res = apiCall { userVerify(jsonOf()) }) {
            is ApiResult.Ok -> {
                Push.register(this) { userSavePushToken(it) }
