...
import com.sukobin.merchant.databinding.ActivityOtpBinding
...
class OtpActivity : AppCompatActivity() {
    ...
    private fun verify() {
        ...
        lifecycleScope.launch {
            val result = apiCall { merchantLogin(jsonOf("phone" to phone)) }
            setBusy(false)
            ...
            when (result) {
                is ApiResult.Ok -> {
                    ...
                    Push.register(this@OtpActivity) { merchantSavePushToken(it) }
