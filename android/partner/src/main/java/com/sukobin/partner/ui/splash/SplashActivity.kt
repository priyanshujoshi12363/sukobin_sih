package com.sukobin.partner.ui.splash
...
import com.sukobin.partner.databinding.ActivitySplashBinding
...
class SplashActivity : AppCompatActivity() {
    ...
    private suspend fun resolveDestination(): Class<*> {
        ...
        return when (val res = apiCall { partnerMe() }) {
            is ApiResult.Ok -> {
                Push.register(this) { partnerSavePushToken(it) }
